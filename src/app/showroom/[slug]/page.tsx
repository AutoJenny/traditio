    ...
    <main className="max-w-5xl mx-auto py-12 px-4 md:px-0">
      ...
      <section className="flex flex-col md:flex-row gap-10 mb-10">
        ...
        <div className="flex-1 flex flex-col justify-center">
          ...
          <button className="bg-brass text-espresso font-bold rounded px-8 py-3 border-2 border-brass shadow-lg transition-colors duration-200 hover:bg-espresso hover:text-ivory text-lg">Enquire about this item</button>
        </div>
      </section>
