...
function SortableImage({ img, idx, mainImageId, handleAltChange, handleDelete, listeners, attributes, setNodeRef, style, isDragging }) {
  return (
    <div
      ref={setNodeRef}
      style={style}
    ...
    >
      ...
      <button
        ...
        className="absolute top-2 left-2 text-red-600 hover:text-white hover:bg-red-600 rounded-full p-1 bg-white shadow transition"
        title="Delete image"
      >
...
function DraggableImage({ img, idx, mainImageId, handleAltChange, handleDelete }) {
  const {
    attributes,
    listeners,
    setNodeRef,
