  ...
  return (
    <main className="max-w-2xl mx-auto py-16 px-4 text-center">
      ...
      <div className="flex flex-col gap-6 items-center">
        ...
        <Link href="/admin/db" className="bg-brass text-espresso font-bold rounded px-8 py-4 border-2 border-brass shadow hover:bg-espresso hover:text-ivory transition text-2xl w-full max-w-xs flex items-center justify-center gap-4">
          <span className="inline-block align-middle">
            {/* Database Icon: Cylinder/Stack */}
            <svg width="28" height="28" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><ellipse cx="12" cy="5" rx="9" ry="3"/><path d="M3 5v14c0 1.66 4.03 3 9 3s9-1.34 9-3V5"/><path d="M3 12c0 1.66 4.03 3 9 3s9-1.34 9-3"/></svg>
          </span>
          Database
        </Link>
      </div>
